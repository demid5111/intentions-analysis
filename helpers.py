...
def generalize_labels(labels_names):
    ...
    generalization_rule = {"Информативно-воспроизводящий": ["а", "б", "в", "г", "д"],
                           "Эмотивно-консолидирующий": ["е", "ж", "з", "и", "к"],
                           "Манипулятивный тип, доминирование": ["л", "м", "н", "о", "п"],
                           "Волюнтивно-директивный": ["р", "с", "т", "у", "ф"],
                           "Контрольно-реактивный": ["х", "ц", "ч", "ш", "щ"]}
